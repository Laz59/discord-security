...
console.log(`                                                                                                                     
 ...
 _|    _|  _|_|_|      _|_|        _|      _|    _|_|_|      _|_|      _|      _|        _|_|    _|        _|    _|  
           _|                                                                                                        
           _|                       
                                         `.red + ` Bienvenue sur la version `.white + `${config.bot.version}`.green + ` du ` + `Laz Custom Bot`.blue + `                       
...
client.login(process.env.TOKEN).catch(e => { console.log(`[CRITICAL ERROR]`.red + ` Erreur rencontrée: ${e}`) });