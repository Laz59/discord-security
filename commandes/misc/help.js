...
.addField("`bot`", `[Alias:](http://Lazbot) \`botinfo\`,\`abonnement\` \n - Affiche les informations de votre abonnement.`)
.addField("`setavatar`", `[Alias:](http://Lazbot) \`botavatar\`\n - Permet de changer la photo de profil du bot`)
.addField("`setname`", `[Alias:](http://Lazbot) \`botname\`\n - Permet de changer le pseudonyme du Bot`)
.addField("`prefix`", `[Alias:](http://Lazbot) \`setprefix\`\n - Permet de changer le prefixe du bot`)
.addField("`stream`", `[Alias:](http://Lazbot) \`play\`,\`watch\`,\`listen\`,\`setstream\`,\`activity\`\n - Permet de changer l'activité du Bot`)
.addField("`color`", `[Alias:](http://Lazbot) \`colorembed\`,\`theme\`\n - Permet de définir une couleur au embed du Bot.`)
...
> [Liste des commandes](https://v9qx)`)
.addField("`kiss`", `[Alias:](http://Lazbot) \`❌\` \n - Fais un bisous.`)
.addField("`fight`", `[Alias:](http://Lazbot) \`❌\` \n - Combat une personne`)
.addField("`hug`", `[Alias:](http://Lazbot) \`❌\` \n - Fais un calin a une personne.`)
...
> [Liste des commandes](https://v9qx)`)
.addField("`vc`", `[Alias:](http://Lazbot) \`vocalmembers\`,\`voicemember\` \n - Obtenez le nombre de personne en vocal ainsi que le nombre de personne sur le serveur.`)
.addField("`la`", `[Alias:](http://Lazbot) \`listeadmin\` \n - Liste de toutes les personnes ayant la permissions administrateur sur le serveur`)
.addField("`lrm`", `[Alias:](http://Lazbot) \`listerolemembers\` \n - Obtenez la liste de personne dans un rôle`)
.addField("`help`", `[Alias:](http://Lazbot) \`aide\` \n - Affiche la liste des commandes`)
.setFooter(`Laz Bot • Version: ${config.bot.version} • ⚠️ Ceci est une pre-release, cette version n'est pas stable`)
